...
public class JwtService {
    ...
    /**
     * Витягнення імені користувача з токена
     *
     * @param token токен
    ...
    /**
     * Витягнення даних з токена
     *
     * @param token           токен
     * @param claimsResolvers функція витягнення даних
     * @param <T>             тип даних
     * @return дані
     */
    ...
    /**
     * Перевірка токена на простроченість
     *
     * @param token токен
    ...
    /**
     * Витягнення дати закінчення токена
     *
     * @param token токен
    ...
    /**
     * Витягнення всіх даних з токена
     *
     * @param token токен
     * @return дані
     */
